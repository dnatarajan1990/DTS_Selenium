...
import com.WebToolsPageObjects.HomePage.HomePage;
import com.WebToolsPageObjects.LoginPage.LoginPage;
...
import static com.CommonPages.PropertiesClass.LOGIN_TIME_OUT;
import static com.CommonPages.PropertiesClass.USER_PROPERTIES;
...
public class BaseMethods extends AbstractPageObjectClass {
    ...
    public void waitAndClick(WebElement element) {
        try {
            ...
            te.printStackTrace();
            Assert.assertTrue(false, "Element: " + element + " isn't appear on this page!");
        }
    }
    ...
    public void validateDisplayedElements(WebElement element) {
        try {
            Assert.assertTrue(element.isDisplayed(), "Element " + element + " isn't displayed! ");
            Assert.assertTrue(element.isEnabled(), "Element " + element + " isn't enabled! ");
        } catch (NoSuchElementException nse) {
            nse.printStackTrace();
            Assert.assertTrue(false, "This Page doesn't contain element: " + element);
        }
    }
