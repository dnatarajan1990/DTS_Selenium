...
import com.Listeners.FailureListener;
...
public class TestManager {
    ...
    public void setDriver() {
        ...
        if ((CONFIG.getProperty(BROWSER_TYPE_PROP_NAME).equals("firefox"))) {
            ...
            System.setProperty(WEBDRIVER_CHROME_DRIVER, "C:\\Users\\rgandra\\Documents\\JavaTest\\driver\\chromedriver.exe");
            DesiredCapabilities dcaps = new DesiredCapabilities();
            dcaps.setCapability("takesScreenshot", true);
            driver = new ChromeDriver(dcaps);


        } else if (CONFIG.getProperty(BROWSER_TYPE_PROP_NAME).equals("headless")) {
    ...
    private DataSource setUpDatabase() {
        //if(true) return new DriverManagerDataSource();
