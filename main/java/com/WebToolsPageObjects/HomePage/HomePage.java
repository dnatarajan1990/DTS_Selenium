package com.WebToolsPageObjects.HomePage;
...
/**
 * Created by iwanicki on 20.04.2017.
 */
public class HomePage extends BaseMethods {
    ...
    public static final String PORTAL_HOST = "//a[contains(@data-target,'collapseELNKTESTPH')]/..";
    ...
    public static final String CHAT_BUTTON= "//a[contains(@ng-click,'toggleChat')]";
    ...
    public static final String CHECKIT = "//a[@id='simple-Check-it']";
    ...
    public void goToAuditMsgs() {
        try {
            if (!(getAuditMsgs().isDisplayed())) {
                ...
                Assert.assertTrue( getAuditMsgs().isDisplayed(),"Audit msgs navigation bar isn't displayed");
                clickOnAuditMsgs();
            } else {
                waitForElement(getAudit());
                JavascriptExecutor je = (JavascriptExecutor) driver;
    ...
    public void goToReCollectGroups() {
        try {
            if (!(getCollectGroupsNav().isDisplayed())) {
                ...
                Assert.assertTrue( collectGroups.isDisplayed(),"Re-collect groups navigation bar isn't displayed");
    ...
    public void scrollToDown() throws InterruptedException {
        ...
        jer.executeScript("arguments[0].scrollIntoView(true);", currentTime);
