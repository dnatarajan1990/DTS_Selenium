...
public class AcmtRoutesPage extends BaseMethods {
   ...
   // public final String TO_MPID_DROPDOWN="//select[contains(@ng-change,'setToMpid')]";
   ...
   // public final String RESET_BUTTON ="//button[normalize-space()='Reset']";
    public final String RESET_BUTTON="//button[contains(text(),'Reset')]";
    ...
    public  final String NEW_BUTTON ="//button[contains(text(),'New')]";
    ...
    public final String ANY_SINGLE_EDIT_BUTTON ="//button[@class='btn btn-primary btn-xs ng-scope']";
    ...
    public boolean verifyIsStarDisplayedForSingleNewRoute(String toMpid, String testFlag, String gateway, String host) throws InterruptedException {
        try{
            WebElement startIcon = driver.findElement(By.xpath(" //table/tbody/tr/td[text()='"+toMpid+"']//..//td[text()='"+testFlag+"']//..//td[text()='"+gateway+"']//..//td[text()='"+host+"']//../td/span[@ng-if='item.extended.routeActivated']"));
    ...
    public void clickEditOnGivenRout() throws InterruptedException {
       waitForElement(anySingleEditButton);
        anySingleEditButton.click();
    }
    public void markCheckboxOnGivenRout(String toMpid, String testFlag,String gateway, String host) throws InterruptedException {
        WebElement checkbox = driver.findElement(By.xpath("//td[text()='"+toMpid+"']//..//td[text()='"+testFlag+"']//..//td[text()='"+gateway+"']//..//td[text()='"+host+"']//..//td/input"));
